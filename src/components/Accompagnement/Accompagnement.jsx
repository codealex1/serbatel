...
export class Accompagnement extends Component {
  render() {
    return (
        <>
        <div class="containerAcc" data-aos="fade-left" data-aos-duration="1500">
            ...
            <div className="container-acc-projet">
                ...
                <div className="step-acc">
                    <FaLayerGroup className="icon-acc" />
                    <h3>ETAPE 2</h3>
                    <p class="p-acc">
